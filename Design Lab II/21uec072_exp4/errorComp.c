 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Feb 15 11:11:46 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                errorComp
...
#define INPUT_0_DIMS_ND                {1,1000}
#define INPUT_0_NUM_ELEMS              1000
#define INPUT_0_WIDTH                  1
#define INPUT_DIMS_0_COL               1000
...
#define INPUT_1_DIMS_ND                {1,1000}
#define INPUT_1_NUM_ELEMS              1000
#define INPUT_1_WIDTH                  1
#define INPUT_DIMS_1_COL               1000
...
#define OUTPUT_0_DIMS_ND               {1,1000}
#define OUTPUT_0_NUM_ELEMS             1000
#define OUTPUT_0_WIDTH                 1
#define OUTPUT_DIMS_0_COL              1000
...
extern void errorComp_Outputs_wrapper(const creal_T *u1,
  const creal_T *u2,
  creal_T *y);
...
{
  const creal_T *u1 = (creal_T *) ssGetInputPortRealSignal(S, 0);
  const creal_T *u2 = (creal_T *) ssGetInputPortRealSignal(S, 1);
  creal_T *y = (creal_T *) ssGetOutputPortRealSignal(S, 0);
  errorComp_Outputs_wrapper(u1, u2, y);
}
