 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Feb 15 11:03:57 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                detection
...
extern void detection_Outputs_wrapper(const creal_T *u,
  creal_T *y);
...
{
  const creal_T *u = (creal_T *) ssGetInputPortRealSignal(S, 0);
  creal_T *y = (creal_T *) ssGetOutputPortRealSignal(S, 0);
  detection_Outputs_wrapper(u, y);
}
